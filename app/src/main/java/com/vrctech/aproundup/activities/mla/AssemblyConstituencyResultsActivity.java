...
public class AssemblyConstituencyResultsActivity extends BaseActivity {

    public static String DISTRICT_TAG = "DISTRICT";
    public static String CONSTITUENCY_TAG = "CONSTITUENCY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        district = intent.getStringExtra(DISTRICT_TAG);
    ...
    protected void onStart() {
        ...
        databaseReference = DatabaseInstance.getDatabaseReference(this).child("AP MLA").child("Districts").child(district).child(constituency);
        candidates = new ArrayList<>();

        getCandidates(databaseReference.child("Candidates"));
    ...
    public void getCandidates(DatabaseReference databaseReference){
